...
export const DB_REASON_META: Record<DbReason, ReasonMeta> = {
  did_not_know: {
    ...
    strategy: 'Assista à aula do tema no SanarFlix',
    colorBase: '#f43f5e',
    colorBg: '#fff1f2',
    colorBorder: '#fecdd3',
    colorText: '#be123c',
  ...
  did_not_remember: {
    ...
    strategy: 'Crie flashcards no app.',
    colorBase: '#8b5cf6',
    colorBg: '#f5f3ff',
    colorBorder: '#ddd6fe',
    colorText: '#6d28d9',
  ...
  reading_error: {
    ...
    strategy: 'Faça o simulado num ambiente sem distrações.',
    colorBase: '#f59e0b',
    colorBg: '#fffbeb',
    colorBorder: '#fde68a',
    colorText: '#854d0e',
  ...
  confused_alternatives: {
    ...
    hint: 'Sabia mais ou menos, mas confundi condições parecidas.',
  ...
  did_not_understand: {
    ...
    strategy: 'Releia com calma e veja o que não ficou claro.',
    colorBase: '#6b7280',
    colorBg: '#f9fafb',
    colorBorder: '#e5e7eb',
    colorText: '#374151',
  ...
  guessed_correctly: {
    ...
    hint: 'Acertei por eliminação, sem entender o raciocínio todo.',
