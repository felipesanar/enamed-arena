...
/* ──────────────────────────────────────────────────────────────────────────
 * FilterBar (legado) — chips segmented, acessível, tokens.
 *
 * Usado APENAS pela página legada `CadernoErrosPage` (rota /caderno-erros,
 * renderizada via LegacyCadernoGate quando a flag v2 está off). A casca v2
 * (CadernoPage) usa o `FilterBar` redesenhado em `./FilterBar`, com busca e
 * contagem via props. Mantido separado para não acoplar o rollback ao v2.
 * ────────────────────────────────────────────────────────────────────────── */
