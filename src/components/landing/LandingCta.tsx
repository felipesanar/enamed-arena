    ...
    >
      <div className="max-w-[1280px] mx-auto">
        <motion.div
          ...
          className="relative rounded-3xl border border-border overflow-hidden p-8 md:p-12 lg:p-14 bg-card/80 shadow-2xl text-center"
          style={{
            background:
        ...
        >
          ...
          >
            <motion.p
              ...
              className="text-body-sm text-primary font-medium mb-3"
            >
            ...
            <motion.h2
              variants={headerItemReveal}
              id="cta-heading"
              className="text-[2.5rem] md:text-[3.5rem] lg:text-[4rem] font-bold text-foreground leading-[0.94] tracking-tight"
            >
            ...
            <motion.p
              variants={headerItemReveal}
              className="mt-5 text-body-lg text-muted-foreground max-w-[36rem] mx-auto leading-relaxed"
            >
