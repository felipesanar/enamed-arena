  ...
  if (scenario.type === "no_upcoming") {
    return (
      <BannerShell tone="calm">
        ...
        <Link
          to="/simulados"
          className="inline-flex shrink-0 items-center gap-1.5 text-[12px] font-semibold text-muted-foreground transition-colors hover:text-foreground max-md:w-full max-md:justify-center max-md:rounded-full max-md:border max-md:border-primary/15 max-md:bg-card/60 max-md:py-2 max-md:text-[11px] no-underline"
        >
          Ver calendário
...
function BannerShell({
  ...
  const toneStyles: Record<BannerTone, string> = {
    urgent:
      "border-primary/25 bg-[linear-gradient(100deg,hsl(var(--primary)/0.14)_0%,hsl(var(--primary)/0.07)_50%,hsl(var(--card)/0.8)_100%)] shadow-[0_14px_32px_-20px_hsl(var(--primary)/0.5),0_2px_10px_-4px_hsl(var(--primary)/0.18)]",
    celebration:
      "border-primary/20 bg-[linear-gradient(100deg,hsl(var(--primary)/0.1)_0%,hsl(var(--primary)/0.05)_48%,hsl(var(--card)/0.82)_100%)] shadow-[0_12px_28px_-18px_hsl(var(--primary)/0.45),0_2px_8px_-4px_hsl(var(--primary)/0.16)]",
    neutral:
      "border-primary/14 bg-[linear-gradient(100deg,hsl(var(--primary)/0.08)_0%,hsl(var(--primary)/0.03)_52%,hsl(var(--card)/0.85)_100%)] shadow-[0_10px_24px_-18px_hsl(var(--primary)/0.3),0_2px_8px_-4px_hsl(var(--primary)/0.12)]",
    calm: "border-border/60 bg-[linear-gradient(100deg,hsl(var(--primary)/0.04)_0%,hsl(var(--primary)/0.02)_56%,hsl(var(--card)/0.9)_100%)] shadow-[0_6px_18px_-14px_hsl(var(--primary)/0.2)]",
  };
  ...
  return (
    ...
    >
      {tone === "urgent" && (
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_0%_50%,hsl(var(--primary)/0.08)_0%,transparent_60%)]" />
      )}
      {tone === "celebration" && (
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_80%_at_100%_50%,hsl(var(--primary)/0.06)_0%,transparent_50%)]" />
      )}
      <div className="relative flex flex-row items-start gap-2 sm:items-center sm:gap-3">
        <div className="relative mt-0.5 shrink-0 sm:mt-0">
          ...
          {(tone === "urgent" || tone === "celebration") && (
            <span className="absolute -top-0.5 -right-0.5 h-2 w-2 rounded-full bg-destructive ring-2 ring-card/80 max-md:h-1.5 max-md:w-1.5 max-md:ring-1" />
          )}
        </div>
