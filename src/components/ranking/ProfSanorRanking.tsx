...
import { Sparkles, Loader2, RefreshCw, Trophy, AlertCircle } from 'lucide-react';
      ...
      <div className="w-full">
        ...
        <div className="relative group/bubble">
          ...
          <motion.div
            ...
            className={`relative z-10 rounded-2xl border border-border/60 bg-card ${compact ? 'px-4 py-3' : 'px-5 md:px-6 py-4 md:py-5'} shadow-[0_10px_40px_-15px_hsl(var(--primary)/0.18)] group-hover/bubble:shadow-[0_15px_50px_-10px_hsl(var(--primary)/0.22)] transition-shadow${markdown && displayMarkdown !== markdown ? ' cursor-pointer' : ''}`}
          >
            {loading && !markdown && (
