...
If you are unable to write these files directly, use `python .cursor/skills/superpowers-workflow/scripts/write_artifact.py --path <target>` to persist the content.
